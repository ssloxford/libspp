...
sppinfo: src/sppinfo.cpp
	g++ -static --std=c++20 -o bin/sppinfo -I ./include/ -g src/sppinfo.cpp -lfec

spppack: src/spppack.cpp
	g++ -static --std=c++20 -o bin/spppack -I ./include/ -g src/spppack.cpp -lfec

sppunpack: src/sppunpack.cpp
	g++ -static --std=c++20 -o bin/sppunpack -I ./include/ -g src/sppunpack.cpp -lfec

sppfilter: src/sppfilter.cpp
	g++ -static --std=c++20 -o bin/sppfilter -I ./include/ -g src/sppfilter.cpp -lfec
